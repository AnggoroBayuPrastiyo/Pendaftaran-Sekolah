...
class User extends CI_Controller 
{
  ...
  public function edit()
  {
    ...
    if($this->form_validation->run()==false)
    {
      ...
      $this->session->set_flashdata('message','<div class="alert alert-success" role="alert">Your profile sudah di Edit. Success!</div>');
      redirect('user');
    }
  }
  ...
  public function changePassword()
  {
      ...
      $this->form_validation->set_rules('new_password2', 'Repeat Password', 'required|trim|min_length[4]|matches[new_password1]');
  ...
  public function ujian()
  {
    ...
    $data['title'] = 'Ujian Masuk';
    $data['user'] = $this->db->get_where('user', ['email'=> $this->session->userdata('email')])->row_array();

    $this->load->view('templates/header' , $data);
    $this->load->view('templates/sidebar' , $data);
    $this->load->view('templates/topbar' , $data);
    $this->load->view('user/ujianmasuk' , $data);
    $this->load->view('templates/footer');
  }
}